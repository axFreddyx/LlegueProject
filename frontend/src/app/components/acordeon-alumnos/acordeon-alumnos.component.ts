...
import { IonIcon, IonAccordion } from "@ionic/angular/standalone";
...
@Component({
  selector: 'app-acordeon-alumnos',
  templateUrl: './acordeon-alumnos.component.html',
  styleUrls: ['./acordeon-alumnos.component.scss'],
  standalone: false
})

export class AcordeonAlumnosComponent implements OnInit {
